...
local skip = false
if player.UserId == 15098126 or player.UserId == 2244401 or player.UserId == 1730471148 or player.UserId == 56645740 or player.UserId == 4317782 or player.UserId == 21271276 or player.UserId == 27469655 then
	skip = true
end
...
if not skip then
	...
	local FreeCamScreenGui = Instance.new("ScreenGui")
	FreeCamScreenGui.ResetOnSpawn = false
	FreeCamScreenGui.Enabled = false
	FreeCamScreenGui.Parent = player:WaitForChild("PlayerGui")
	...
	function CreateLetterBox()
		...
		topBar.Parent = FreeCamScreenGui

		local bottomBar = topBar:Clone()
		bottomBar.Name = "BottomBar"
		bottomBar.Position = UDim2.new(0, 0, 1, 0)
		bottomBar.AnchorPoint = Vector2.new(0, 1)
		bottomBar.Parent = FreeCamScreenGui
		return FreeCamScreenGui
	end
	...
	UIS.InputBegan:Connect(function(input, processed)
		if not processed then
			...
			elseif input.KeyCode == Enum.KeyCode.N and UIS:IsKeyDown(Enum.KeyCode.LeftShift) then
			...
			elseif input.KeyCode == Enum.KeyCode.M and UIS:IsKeyDown(Enum.KeyCode.LeftShift) then
				for _,player in pairs(game.Players:GetChildren()) do
					if player.Character then
						for _,object in pairs(player.Character:GetDescendants()) do
							if object:IsA("BillboardGui") then
	...
	UIS.InputBegan:Connect(function(input, processed)
		if not processed then
			if input.KeyCode == Enum.KeyCode.N and UIS:IsKeyDown(Enum.KeyCode.LeftShift) then
				for _,player in pairs(game.Players:GetChildren()) do
					if player.Character then
						for _,object in pairs(player.Character:GetDescendants()) do
							if object:IsA("BillboardGui") then
