...
local table = require(Utility:WaitForChild("Table"))
...
local CF_REALLY_FAR_AWAY = CFrame.new(0, 100000, 0)
...
function PartCacheStatic:ReturnPart(part: BasePart, canOverlap: BoolValue)
